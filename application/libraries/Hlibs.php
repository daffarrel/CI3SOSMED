...
require_once( APPPATH.'/third_party/hybridauth/Hybrid/thirdparty/Facebook/autoload.php' );

class Hlibs extends Hybrid_Auth
{
	function __construct($config = array())
	{
		...
		log_message('debug', 'Hlibs Class Initalized');
	}
	/**
	 * @deprecated
	 */
...
/* Location: ./application/libraries/Hlibs.php */